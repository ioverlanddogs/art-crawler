...
# @artio/app prisma:push requires DATABASE_URL; DATABASE_URL_DIRECT falls back to DATABASE_URL when unset
...
## Deployment and production docs
- [`docs/deploy-vercel-webui.md`](docs/deploy-vercel-webui.md) — step-by-step Vercel deployment guide for `packages/app`
- [`docs/environment-reference.md`](docs/environment-reference.md) — environment variables by runtime
- [`docs/vercel-launch-checklist.md`](docs/vercel-launch-checklist.md) — pre-launch and post-deploy checklist
- [`docs/admin-operations-runbook.md`](docs/admin-operations-runbook.md) — day-to-day operating guide for the admin panel
