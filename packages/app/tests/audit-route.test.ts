...
describe('audit route', () => {
  ...
  test('returns unified audit events from all four sources', async () => {
    ...
    prismaMock.proposedChangeSet.findMany.mockResolvedValueOnce([
      { id: 'cs1', reviewStatus: 'merged', matchedEventId: 'evt-1', sourceDocumentId: 'src-1', reviewedByUserId: 'mod-1', notes: 'Looks good', reviewedAt: new Date('2026-01-03T00:00:00.000Z'), updatedAt: new Date('2026-01-03T00:00:00.000Z') }
    ]);
